...
![スクリーンショット 2025-03-17 3.03.46 (1).png](<attachment:c8fed102-c5da-4d87-a428-6a0f018a630f:スクリーンショット_2025-03-17_3.03.46_(1).png>)

Empty Activity を選択して Next をクリックします。

![スクリーンショット 2025-03-17 3.04.21.png](attachment:bab1a51a-ef4e-495e-92ea-187c17876037:スクリーンショット_2025-03-17_3.04.21.png)
...
![スクリーンショット 2025-03-17 3.16.54.png](attachment:4b99e8fe-63a7-4a5c-a4f8-f257016e3006:スクリーンショット_2025-03-17_3.16.54.png)

Finish を押すと自動でプロジェクトを開きます。しばらくは indexing など IDE 側の処理が走るので少し待ちます。

![スクリーンショット 2025-03-17 3.05.59.png](attachment:38f42b37-bfb7-4cf3-98a7-4cef5062f938:スクリーンショット_2025-03-17_3.05.59.png)

完了したらこんな感じの画面になります。

![as_project_view.png](attachment:d3910c32-2404-4b13-bdd3-4a701aeb210a:as_project_view.png)
...
![image (1).png](<attachment:185cf20b-19e1-4f04-a52e-eb3978ef7bff:image_(1).png>)

Create Virtual Device をクリックします。

![スクリーンショット 2025-03-24 0.52.11.png](attachment:0c9a6fe7-2dc0-44a5-8273-46639d2dcb42:スクリーンショット_2025-03-24_0.52.11.png)

エミュレートする端末を選択します。

![スクリーンショット 2025-03-25 17.38.40.png](attachment:b9b32f23-f35b-4495-ba59-3843e2e7bdce:スクリーンショット_2025-03-25_17.38.40.png)

Finish をクリックします。システムイメージの DL が始まった場合は完了するまで待ちます。

![スクリーンショット 2025-03-24 0.53.41.png](attachment:7bd64bf6-7b8b-4faf-aae2-727aab8f6a00:スクリーンショット_2025-03-24_0.53.41.png)

### 実機の場合

まずは、開発者モードを有効にします。設定アプリを開き、デバイス情報を確認できる画面に遷移してください。ビルド番号を 7 回タップすると有効にできます。

![スクリーンショット 2025-04-11 11.52.21.png](attachment:d6eab30a-1d6a-411e-b05d-0dc1f7534b41:スクリーンショット_2025-04-11_11.52.21.png)

![スクリーンショット 2025-04-11 11.52.32.png](attachment:69097b5f-8a16-4f82-9fd3-958f710fde80:スクリーンショット_2025-04-11_11.52.32.png)

**USB で接続する**

USB をお持ちの方は PC と実機を接続してください。接続できると以下のように接続したデバイス情報が表示されると思います。

![スクリーンショット 2025-03-25 17.52.23.png](attachment:a70be94c-ae24-4abd-a426-51f419c5fe60:スクリーンショット_2025-03-25_17.52.23.png)

**Wi-Fi で接続する**

Wi-Fi で接続する場合は、青矢印の部分をクリックします。

![スクリーンショット 2025-03-25 17.48.42.png](attachment:48e92e1e-72d7-4477-89e6-9b7c5a7a7acb:スクリーンショット_2025-03-25_17.48.42.png)

二次元コードが表示されるので、設定アプリの開発者オプションから実機で読み取ってください。

![スクリーンショット 2025-04-11 11.14.06.png](attachment:00596b02-20cd-45de-8141-09f287d42496:スクリーンショット_2025-04-11_11.14.06.png)

![スクリーンショット 2025-04-11 11.46.57.png](attachment:ce71367e-86c9-4854-b80b-0e7be272d7d2:スクリーンショット_2025-04-11_11.46.57.png)
...
![スクリーンショット 2025-03-25 18.05.04.png](attachment:fd599999-e73e-4ead-846e-6f2545ed3ffc:スクリーンショット_2025-03-25_18.05.04.png)
...
![my_gif.gif](attachment:8df06f58-fa13-484b-b04f-8d6e5dee6fc6:my_gif.gif)
